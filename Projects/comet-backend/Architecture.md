...
| `tariff_classifier.py` (`TariffClassifierService`) | Агрегат справочников для формы черновика тарифа: дерево ветки услуг склеивается из четырёх плоских списков, словари читаются параллельно. Кеш в Redis на час, пересборка под локом; недоступность классификатора — 502, а не 500 — [[API]] |
