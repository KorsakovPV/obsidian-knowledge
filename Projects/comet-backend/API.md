...
| Метод | Путь | Назначение | Право |
|-------|------|-----------|-------|
| GET | `/lkm/roles` | Справочник ролей (4 роли) с дефолтными наборами прав | `require_admin` (роль `admin`) |
| GET | `/lkm/permissions` | Справочник пермиссий (16 шт.) | `require_admin` (роль `admin`) |
